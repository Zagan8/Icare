...
const InNeedPage: React.FC = () => {
  ...
  const helpTypes = [
    {
      name: "Provision",
      img: "https://news.europawire.eu/wp-content/uploads/2019/02/SGS-can-now-offer-FSMA-certification-for-VQIP-and-FSVP-to-foreign-food-importers-into-the-US.jpg",
    },
    {
      name: "Financial support",
      img: "https://employeebenefits.co.uk/content/uploads/2021/09/financial-support.png",
    },
    {
      name: "Emotional support",
      img: "https://manchesterinklink.com/wp-content/uploads/2017/02/Screen-Shot-2017-02-02-at-2.19.14-PM-336x228.png",
    },
    {
      name: "Other",
